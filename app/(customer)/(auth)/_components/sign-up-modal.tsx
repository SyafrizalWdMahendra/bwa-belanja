...
export default function SignUpModal() {
  ...
  // {/* Tombol Sign Up (Di luar modal, tombol biasa) */}
  //       <Link
  //         href="/sign-up"
  //         className="p-[12px_20px] bg-white rounded-full font-semibold border border-transparent hover:border-[#E5E5E5] transition-colors"
  //       >
  //         Sign Up
  //       </Link>
  return (
